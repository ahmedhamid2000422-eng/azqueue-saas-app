    ...
    <Shell isKiosk={isKiosk}>
      ...
      <form onSubmit={handleSubmit} className={`mt-4 ${isKiosk ? "space-y-4" : "space-y-6"}`}>
        ...
        {/* While texting is unavailable, say so rather than showing nothing.
            ...
            texting. */}
        {/* The "text updates · coming soon" notice lived here. It is gone:
            the A2P campaign was approved on 4 September and texts now send,
            so promising them as a future feature is simply false. When SMS is
            switched off entirely, the consent box and phone field disappear
            and the footer already says we will email — no separate notice is
            needed to explain an absence nobody can see. */}
